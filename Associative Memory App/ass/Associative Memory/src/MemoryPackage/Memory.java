...
public class Memory {
	...
	public void init() throws IOException {
		...
		//ImageProcessing i = new ImageProcessing("", 1); 
		//i.writeImage(Vx2.vect);
	}
	...
	public Matrix ComputeMemory() {
		...
		result2.Multiply2Vector(Vx3, Vx3);
	...
	public void recallY() throws NumberFormatException, IOException {
		...
		ImageProcessing img = new ImageProcessing("", 1); 
		img.writeImage(prevYY.vect , "Yresult");
	}
