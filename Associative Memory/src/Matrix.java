public class Matrix {
	...
	public Matrix Multiply2Vector(Vector y, Vector x) {
	...
	public Vector MultiplyMatrixWithVector(Matrix w, Vector v) {
		...
		Vector op = new Vector(arr,w.row);
		op.vect = arr;
		return op;
	}
	...
	public Vector MultiplyVectorWithMatrix(Matrix w, Vector v) {
		...
		Vector op = new Vector(arr,w.column);
		op.vect = arr;
		return op;
	}
